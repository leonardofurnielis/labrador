...
# loader = IBMS3Loader(bucket="spyder-bucket", 
...
#############  Test llama-index json

# from llama_index.readers.json import JSONReader

# reader = JSONReader()

# documents = reader.load_data(input_file="../data/DATIFIR com limit 100 199 ate Fim.json")
...
# loader = JSONLoader(
#     file_path='./DATIFIR com limit 100 199 ate Fim.json',
...
# loader = JSONLoader(
#     file='../data/DATIFIR com limit 100 199 ate Fim.json',
#     jq_schema='.results[].body.view.value')
...
#############  Test Spyder Json from directory

from spyder_index.ingestion import DirectoryLoader

loader = DirectoryLoader()

docs = loader.load_data('../data/')
