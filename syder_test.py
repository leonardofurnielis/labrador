...
# embed_engine = HuggingFaceEmbeddings(model_name="intfloat/multilingual-e5-small")

# text_embed = embed_engine.get_query_embedding(text)
...
# response = """GRC significa governança, risco e conformidade. É um método estruturado de alinhar a TI às metas dos negócios com gerenciamento dos riscos e cumprimento de todas as regulamentações governamentais e do setor. Essa metodologia inclui ferramentas e processos para unificar o gerenciamento de governança e risco de uma organização com suas iniciativas de inovação e adoção de tecnologia. As empresas usam o GRC para concretizar metas organizacionais de modo confiável, eliminar incertezas e cumprir requisitos"""

# kb_1 = "Governança, risco e conformidade (GRC) é um método estruturado de alinhar a TI às metas dos negócios com gerenciamento dos riscos e cumprimento de todas as regulamentações governamentais e do setor. Essa metodologia inclui ferramentas e processos para unificar o gerenciamento de governança e risco de uma organização com suas iniciativas de inovação e adoção de tecnologia. As empresas usam o GRC para concretizar metas organizacionais de modo confiável, eliminar incertezas e cumprir requisitos de"
# kb_2 = "GRC significa governança, (gerenciamento de) risco e conformidade. A maioria das empresas conhece esses termos, mas os praticavam separadamente no passado. O GRC combina governança, gerenciamento de riscos e conformidade em um modelo coordenado. Isso ajuda sua empresa a reduzir o desperdício, aumentar a eficiência, diminuir riscos de não conformidade e compartilhar informações com mais eficiência. Governança é o conjunto de políticas, regras ou frameworks que uma empresa usa para atingir suas metas de negócios."
# kb_3 = "IBM, or International Business Machines Corporation, is a multinational technology company that was founded in 1911. Headquartered in Armonk, New York, IBM is known for its innovative products and services in the fields of hardware, software, and cloud computing. Over the years, IBM has played a significant role in shaping the technology industry, with notable contributions such as the development of the first computer hard disk drive and the creation of the Watson supercomputer. Today, IBM continues to be a leader in the industry, with a focus on artificial intelligence, blockchain, and quantum computing."
...
# kb_coverage = KnowledgeBaseCoverage()

# res_coverage = kb_coverage.evaluate([kb_1,kb_2,kb_3], response)
